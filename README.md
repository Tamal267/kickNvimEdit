...
* run: `git clone https://github.com/Tamal267/kickNvimEdit ~/.config/nvim` OR: gh repo clone nvim-lua/kickstart.nvim
...
If your uses clang version 12 then you have to install c++12. Run these command and install c++-12 version. 
